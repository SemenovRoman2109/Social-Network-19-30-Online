...
SECRET_KEY = 'django-insecure-*8$iw$40#1*od896(pqog@4!wah^1do(v4zzlyp_@^yx#&3*(u'
...
# константа, що відповідає за те як django channels відповідають за обробку асинхронних повідомлень 
CHANNEL_LAYERS = {
